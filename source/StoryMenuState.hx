...
class StoryMenuState extends MusicBeatState
{
	...
	var weekNames:Array<Dynamic> = CoolUtil.coolTextFile('assets/cooltextfiles/weekNames.txt');
	...
	override function create()
	{
		...
		var ui_tex = FlxAtlasFrames.fromSparrow('assets/images/hud/campaign_menu_UI_assets.png', 'assets/images/hud/campaign_menu_UI_assets.xml');
