...
class MenuItem extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, weekNum:Int = 0)
	{
		...
		var tex = FlxAtlasFrames.fromSparrow('assets/images/hud/campaign_menu_UI_assets.png', 'assets/images/hud/campaign_menu_UI_assets.xml');
	...
	override function update(elapsed:Float)
	{
		...
		y = FlxMath.lerp(y, (targetY * 120) + 480, 0.17 * elapsed);
	}
}
